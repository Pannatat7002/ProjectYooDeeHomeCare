                ...
                <div className="bg-indigo-50 py-16">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="flex justify-center gap-4">
                            <Link href="/" className="bg-indigo-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition-colors inline-flex items-center">
                                ค้นหาศูนย์ดูแล <ArrowRight className="ml-2 w-5 h-5" />
                            </Link>
                            <Link href="/contact" className="bg-white text-indigo-600 border border-indigo-600 px-8 py-3 rounded-lg font-semibold hover:bg-indigo-50 transition-colors">
                                ติดต่อเรา
                            </Link>
                        </div>
                    </div>
