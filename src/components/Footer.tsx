                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li><Link href="/about" className="hover:text-indigo-400 transition-colors">เกี่ยวกับเรา</Link></li>
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li><Link href="/services" className="hover:text-indigo-400 transition-colors">บริการทั้งหมด</Link></li>
